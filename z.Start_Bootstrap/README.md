###### This is the original directory/files/content from [Start Bootstrap - Freelancer](https://startbootstrap.com/template-overviews/freelancer/) containing information about the template. See below:
